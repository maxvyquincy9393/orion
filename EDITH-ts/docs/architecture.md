...
[Identity Layer — OpenClaw Paradigm]
  workspace/SOUL.md       ← who Nova is (static, source of truth)
...
The static identity (who Nova is, values, tone) lives in `workspace/SOUL.md`.
