...
## Tujuan
Buat workspace/ directory dengan semua bootstrap files yang benar sesuai EDITH pattern.
...
## Real Pattern dari EDITH Source

Dari `src/agents/bootstrap-files.ts` di repo EDITH:
...
```
Kamu sedang menyiapkan workspace structure untuk EDITH-TS, mengikuti EDITH pattern
...
Reference: github.com/edith/edith (src/agents/bootstrap-files.ts)
...
Ini adalah fondasi dari semua EDITH-style features.
