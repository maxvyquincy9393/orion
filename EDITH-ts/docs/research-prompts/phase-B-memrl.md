...
selalu lakukan commit dan push setiap step
## Paper
**MemRL: Self-Evolving Agents via Runtime Reinforcement Learning on Episodic Memory**
arXiv: 2601.03192 | Jan 2026 | Shanghai Jiao Tong University + NUS

## Core Idea dari Paper
Memory sekarang di Nova itu passive — simpan lalu retrieve by similarity.
...
```
Kamu sedang memodifikasi Nova-TS. Implementasi MemRL pattern ke memory system.
...
sqlite3 .nova/nova.db "SELECT content, utilityScore FROM MemoryNode ORDER BY utilityScore DESC LIMIT 10"
```
