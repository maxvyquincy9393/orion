 ...
 *
 * Notes stored in .nova/notes/YYYY-MM-DD.md (one file per day)
...
const NOTES_DIR = path.resolve(process.cwd(), ".nova", "notes")
...
Notes persist across sessions in .nova/notes/.
