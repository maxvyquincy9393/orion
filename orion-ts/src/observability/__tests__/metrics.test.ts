...
describe("observability metrics", () => {
  it("records gateway, engine, and memory metrics", async () => {
    ...
    expect(metrics).toContain("orion_http_requests_total")
    expect(metrics).toContain("orion_engine_calls_total")
    expect(metrics).toContain("orion_memory_retrievals_total")
  })
})
